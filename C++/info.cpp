...
void addData(string studentId){
    ...
    cout<<"Which data wouldyou like to add?(type a number only!)"<<endl<<"1:Student ID"<<endl<<"2:Name"<<endl<<"3:Age"<<endl<<"4:Gender"<<endl<<"5:Contact"<<endl<<"6:Address"<<endl<<"-->";
    int act;
    cin>>act;
    if(act == 1 && info[Id][0][1] == ""){
        ...
        cout<<"This data is already occupied, would you like to edit it?(1: Yes)";
        int Eact;
        cin>>Eact;
        if(Eact == 1){
            editData(studentId);
...
void searchData(string studentId){
    ...
    while(true){
        ...
        if(search == "stop"){
            ...
            for(int i = 0; i <= 6; i++){
                if(info[Id][i][1] == search){
                    system("cls");
                    cout<<search<<" is a "<<info[Id][i][0]<<" Data Value."<<endl;
                    success = 1;
                }
            }
            if (success != 1){
...
void editData(string studentId){
    int Id = checkId(studentId);
    cout<<"Student ID : "<<studentId<<endl;
    cout<<"Which data wouldyou like to edit?(type a number only!)"<<endl<<"1:Student ID"<<endl<<"2:Name"<<endl<<"3:Age"<<endl<<"4:Gender"<<endl<<"5:Contact"<<endl<<"6:Address"<<endl<<"-->";
    int act;
    cin>>act;
    if(act == 1 && info[Id][0][1] != ""){
        cout<<"Enter a Student ID"<<endl<<"Student ID : ";
...
void deleteData(string studentId){
    int Id = checkId(studentId);
    cout<<"Student ID : "<<studentId<<endl;
    cout<<"Which data wouldyou like to Delete?(type a number only!)"<<endl<<"1:Student ID"<<endl<<"2:Name"<<endl<<"3:Age"<<endl<<"4:Gender"<<endl<<"5:Contact"<<endl<<"6:Address"<<endl<<"-->";
    int act;
    int sure;
    cin>>act;
    if(act == 1 && info[Id][0][1] != ""){
